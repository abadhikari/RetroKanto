...
int main() {
  ...
  // Set up shaders
  ShaderProgram shaderProgram("shader/vertex_shader.glsl", "shader/fragment_shader.glsl");
  ...
  Renderer renderer(&camera, &shaderProgram);
  ...
  Mesh cube(vertices, colors, sizeof(vertices));

  glm::mat4 modelMatrix = glm::mat4(1.0f);

  // Accept only the fragments closer to the screen
